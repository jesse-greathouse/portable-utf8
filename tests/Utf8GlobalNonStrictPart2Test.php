...
final class Utf8GlobalNonStrictPart2Test extends \PHPUnit\Framework\TestCase
{
 ...
 =?UTF-8?Q?_php.?=';
    ...
    public function testSubstrCompare()
    {
        ...
        static::assertSame(0, \substrCompare(12345, 23, 1, 2));
        static::assertSame(0, UTF8::substrCompare(12345, 23, 1, 2));
    ...
    public function testSubstrCount()
    {
        ...
        static::assertSame(\substrCount('', ' '), UTF8::substrCount('', ' '));
        static::assertSame(\substrCount(' ', ' '), UTF8::substrCount(' ', ' '));
        static::assertSame(\substrCount('DJ', ' '), UTF8::substrCount('DJ', ' '));
        static::assertSame(\substrCount('', 'Σ'), UTF8::substrCount('', 'Σ'));
        static::assertSame(\substrCount(' ', 'Σ'), UTF8::substrCount(' ', 'Σ'));
        static::assertSame(\substrCount('DJ', ' '), UTF8::substrCount('DJ', ' '));
        static::assertSame(\substrCount('', 'Σ'), UTF8::substrCount('', 'Σ'));
        static::assertSame(\substrCount(' ', 'Σ'), UTF8::substrCount(' ', 'Σ'));
        ...
        if (!\jessegreathouse\helper\Bootup::is_php('8.0')) {
            if (UTF8::getSupportInfo('mbstring_func_overload') === true) {
                /** @noinspection PhpUsageOfSilenceOperatorInspection */
                static::assertNull(@\substrCount('', '', 1, 1));
            } else {
                /** @noinspection PhpUsageOfSilenceOperatorInspection */
        ...
        if (!\jessegreathouse\helper\Bootup::is_php('8.0')) {
            if (UTF8::getSupportInfo('mbstring_func_overload') === true) {
                /** @noinspection PhpUsageOfSilenceOperatorInspection */
                static::assertNull(@\substrCount('', 'test', 1, 1));
            } else {
                /** @noinspection PhpUsageOfSilenceOperatorInspection */
        ...
        static::assertSame(0, UTF8::substrCount('  ', 'test', 1, 1));
        static::assertSame(0, \substrCount('  ', 'test', 1, 1));
        ...
        if (UTF8::getSupportInfo('mbstring_func_overload') === true) {
            static::assertNull(\substrCount('test', 'test', 1, 1));
        } else {
        ...
        if (UTF8::getSupportInfo('mbstring_func_overload') === true) {
            static::assertNull(\substrCount(12345, 23, 1, 2));
        } else {
            static::assertSame(1, \substrCount(12345, 23, 1, 2));
        }

        static::assertSame(1, UTF8::substrCount(12345, 23, 1, 2));
        ...
        if (Bootup::is_php('7.1')) {
            if (UTF8::getSupportInfo('mbstring_func_overload') === true) {
                static::assertNull(\substrCount('abcde', 'de', -2, 2));
            } else {
        ...
        if (UTF8::getSupportInfo('mbstring_func_overload') === true) {
            /** @noinspection PhpUsageOfSilenceOperatorInspection */
            static::assertNull(@\substrCount('abcde', 'bcg', 1, 2));
        } else {
            /** @noinspection PhpUsageOfSilenceOperatorInspection */
        ...
        if (UTF8::getSupportInfo('mbstring_func_overload') === true) {
            /** @noinspection PhpUsageOfSilenceOperatorInspection */
            static::assertNull(@\substrCount('abcde', 'BC', 1, 2));
        } else {
            /** @noinspection PhpUsageOfSilenceOperatorInspection */
        ...
        if (UTF8::getSupportInfo('mbstring_func_overload') === true) {
            /** @noinspection PhpUsageOfSilenceOperatorInspection */
            static::assertNull(@\substrCount('abcde', 'bc', 1, 3));
        } else {
            /** @noinspection PhpUsageOfSilenceOperatorInspection */
        ...
        if (UTF8::getSupportInfo('mbstring_func_overload') === true) {
            /** @noinspection PhpUsageOfSilenceOperatorInspection */
            static::assertNull(@\substrCount('abcde', 'cd', 1, 2));
        } else {
            /** @noinspection PhpUsageOfSilenceOperatorInspection */
