...
final class Utf8StrcasecmpTest extends \PHPUnit\Framework\TestCase
{
    public function testCompareEqual()
    {
        ...
        static::assertSame(0, u::strCompareInsensitive($str_x, $str_y));
        static::assertTrue(u::strCompare($str_x, $str_y) >= 1);

        $str_x = 'IÑTËRNÂTIÔNÀLIZÆTIØN';
        $str_y = 'IÑTËRNÂTIÔNÀLIZÆTIØN';
        static::assertSame(0, u::strCompareInsensitive($str_x, $str_y));
        static::assertSame(0, u::strCompare($str_x, $str_y));
    }
    ...
    public function testLess()
    {
        ...
        static::assertTrue(u::strCompareInsensitive($str_x, $str_y) > 0);
        static::assertTrue(u::strCompare($str_x, $str_y) > 0);
    }
    ...
    public function testEmptyBoth()
    {
        $str_x = '';
        $str_y = '';
        static::assertSame(u::strCompareInsensitive($str_x, $str_y), 0);
        static::assertSame(u::strCompare($str_x, $str_y), 0);
    }
